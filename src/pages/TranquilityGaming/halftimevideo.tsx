...
const Credits = (props: any) => {
  ...
  return (
    <>
      ...
      <Image
        src="https://www.tranquility.gg/package/digitize/HalftimeNoScore.png"
        alt="background"
        height={1080}
        width={1920}
      ...
      <div className={styles.teamsSide}>
        <div className={[styles.team1Side, styles.team].join(" ")}>
        ...
        <div className={[styles.team2Side, styles.team].join(" ")}>
          <div className={styles.logoContainer}>
            <Image
              className={styles.logo}
              src={data?.teams?.team2?.logoPath}
